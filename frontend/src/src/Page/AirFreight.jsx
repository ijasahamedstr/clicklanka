        ...
        <Container maxWidth="lg">
          ...
          <Grid container spacing={3} sx={{ marginTop: '30px' }}>
            ...
            <Grid item xs={12} sm={6}>
              <img
                src="https://i.ibb.co/JWhcM6mm/air-freight-2.jpg"
                alt="Airplane"
                style={{
                  width: '100%',
            ...
            <Grid item xs={12} sm={6}>
              <Grid container spacing={2}>
                <Grid item xs={12}>
                  <img
                    src="https://i.ibb.co/mCG5BPXj/air-freight-1.jpg"
                    alt="Shipment"
                    style={{
                      width: '100%',
                      height: 'auto', // Ensuring responsiveness
                ...
                <Grid item xs={12}>
                  <img
                    src="https://i.ibb.co/DDKXrrBD/air-freight-3.jpg"
                    alt="Loading"
                    style={{
                      width: '100%',
                      height: 'auto', // Ensuring responsiveness
...
export default AirFreightShipment;
